                ...
                >
                    ...
                    <div className="pt-8 border-t border-slate-900/10 flex flex-col sm:flex-row items-center gap-6">
                        ...
                        <div className="flex gap-4">
                            ...
                            {/*youtube*/}
                            <a href="#" className="p-3 rounded-full hover:bg-red-600 bg-red-700 text-white transition-all duration-300" aria-label="Youtube">
                                <Youtube className="w-5 h-5" />
                            </a>

                            {/*Facebook*/}
                            <a href="#" className="p-3 rounded-full hover:bg-blue-600 bg-blue-700 text-white transition-all duration-300" aria-label="Facebook">
